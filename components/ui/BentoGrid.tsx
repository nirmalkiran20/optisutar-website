...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "hello@optisutar.com";
            ...
            <div className="flex flex-col items-center justify-center h-full gap-4 mt-6">
              <div className="flex flex-wrap gap-2 justify-center">
                {["India", "UAE", "USA", "UK", "Australia", "Singapore"].map((country) => (
                  <span
                    key={country}
                    className="px-3 py-1 rounded-full text-xs font-semibold bg-[#10132E] text-[#C1C2D3] border border-white/10"
                  >
                    {country}
                  </span>
                ))}
