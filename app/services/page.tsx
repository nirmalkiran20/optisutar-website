...
// Premium custom SVG icons for each service
const ServiceIcons: Record<number, React.FC<{ color: string }>> = {
  // AIO — AI brain/neural network
  1: ({ color }) => (
  ...
  // AEO — Speech bubble with checkmark
  3: ({ color }) => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // PPC — Bar chart with upward arrow
  5: ({ color }) => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // Web Design — Browser window with grid
  8: ({ color }) => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  9: ({ color }) => (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="20" cy="10" r="2.5" stroke={color} strokeWidth="1.2"/>
      <circle cx="20" cy="30" r="2.5" stroke={color} strokeWidth="1.2"/>
      <line x1="14" y1="20" x2="17.5" y2="11" stroke={color} strokeWidth="1" strokeLinecap="round" strokeOpacity="0.6"/>
      <line x1="14" y1="20" x2="17.5" y2="29" stroke={color} strokeWidth="1" strokeLinecap="round" strokeOpacity="0.6"/>
    </svg>
  ),
};
          ...
          {services.map((service) => {
            ...
            return (
              <a
                ...
                className="group flex flex-col items-center gap-3 p-4 rounded-2xl border border-white/10 bg-white/5
                  hover:border-white/40 hover:bg-white/10 hover:scale-105 hover:-translate-y-2
                  hover:shadow-xl active:scale-95 transition-all duration-300 ease-out cursor-pointer"
              ...
              >
                ...
                >
                  <div className="flex items-start gap-6">
                    ...
                    <div
                      className="w-20 h-20 p-4 rounded-2xl flex-shrink-0 flex items-center justify-center"
                      style={{
