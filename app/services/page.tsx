...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "From traditional SEO to AI Optimisation — every service your business needs to dominate online.",
...
const services = [
  {
    ...
    benefits: [
      ...
      "Monitor and track AI brand mentions",
  ...
  },
  {
    ...
    color: "#34A853",
    description: "GEO (Generative Engine Optimisation) focuses on making your content the source that AI-powered search engines cite when generating answers. Google AI Overviews, Bing Copilot and other generative engines pull from authoritative, well-structured sources. GEO ensures your website is one of them.",
    benefits: [
      "Appear as a cited source in Google AI Overviews",
      "Structured data and schema markup implementation",
      "E-E-A-T signals to establish topical authority",
      "Content formatted for AI citation and snippet extraction",
      "Competitive analysis of AI-cited competitors",
    ],
    faqs: [
  ...
  },
  {
    ...
    color: "#9333EA",
    description: "AI SEO uses artificial intelligence tools and data analysis to supercharge traditional SEO. We use AI to identify ranking opportunities, analyse competitor strategies at scale, generate optimised content briefs and predict algorithm changes — giving your website a significant competitive advantage.",
    benefits: [
      "AI-powered keyword research and opportunity identification",
      "Automated competitor gap analysis",
      "Content optimisation using NLP and semantic SEO",
      "Predictive ranking analysis",
      "Faster results through AI-assisted execution",
    ],
    faqs: [
      { q: "What makes AI SEO different from regular SEO?", a: "AI SEO uses machine learning tools to process vastly more data than traditional SEO — identifying patterns, opportunities and threats that human analysis would miss or take much longer to find." },
  ...
  },
  {
    ...
    color: "#EA4335",
    description: "Our PPC service manages your Google Ads campaigns from strategy to execution. We build, optimise and scale paid search, display, shopping and YouTube campaigns focused on one goal — maximum return on your ad spend. Every rupee is tracked, every campaign is optimised weekly.",
    benefits: [
      "Full Google Ads account setup and management",
    ...
    faqs: [
      { q: "What is the minimum budget for Google Ads?", a: "We recommend a minimum ad spend of Rs.15,000 per month to generate meaningful data and results. Our management fee is separate from your ad budget." },
  ...
  },
  {
    ...
    color: "#34A853",
    description: "Your Google Business Profile is the most powerful free tool for local visibility. We optimise every element of your profile — from categories and attributes to posts, photos and review management — to ensure you rank at the top of local search results and Google Maps.",
    benefits: [
      "Complete GMB profile audit and optimisation",
      "Category and attribute optimisation",
      "Regular posts, offers and updates",
  ...
  },
  {
    ...
    color: "#FF9500",
    description: "Your online reputation directly impacts customer trust and revenue. We monitor your brand mentions across the web, suppress negative content, amplify positive reviews and build a strong reputation that converts visitors into customers.",
    benefits: [
      "24/7 brand mention monitoring",
      "Negative review response and mitigation",
      "Positive review generation campaigns",
      "Social media reputation management",
      "Crisis response strategy and execution",
    ],
    faqs: [
      { q: "Can you remove negative Google reviews?", a: "We can flag reviews that violate Google policies for removal. For reviews that cannot be removed, we develop professional response strategies and build positive review volume to dilute their impact." },
  ...
  },
  {
    ...
    color: "#4285F4",
    description: "We design and build websites that are fast, mobile-first and built with SEO baked in from day one. Every website we create is optimised for Core Web Vitals, structured data, proper heading hierarchy and conversion — so your site not only looks great but actually generates business.",
    benefits: [
    ...
    faqs: [
      ...
      { q: "Is SEO included in website design?", a: "Yes. Every website we build includes on-page SEO setup — meta tags, schema markup, sitemap, robots.txt, image optimisation and proper URL structure." },
      { q: "How long does a website project take?", a: "A standard business website takes 3-6 weeks. Larger e-commerce or custom projects may take 8-12 weeks depending on complexity." },
    ],
  },
  {
    id: 9,
    ...
    color: "#E1306C",
    description: "We manage your social media presence across Instagram, LinkedIn, Facebook and YouTube — creating content that builds your brand, engages your audience and generates real business leads. From content calendars to paid social campaigns, we handle everything end to end.",
    benefits: [
      "Content strategy and monthly content calendar",
      "Professional graphic design and copywriting",
      "Community management and engagement",
      "Paid social campaigns on Meta and LinkedIn",
    ...
    faqs: [
      ...
      { q: "How many posts per week do you create?", a: "Our standard package includes 3-4 posts per week per platform. Custom packages are available for higher frequency needs." },
      { q: "Do you run paid ads on social media?", a: "Yes. We run Meta and LinkedIn Ads as part of our paid social service, with full campaign management and reporting." },
    ],
  },
];
...
export default function ServicesPage() {
    ...
    <main className="relative bg-black-100 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 px-5">
      <div className="max-w-7xl w-full py-20">
        ...
        <div className="text-center mb-16">
          ...
          <Link href="/#contact">
            <button
              className="mt-8 px-8 py-3 rounded-lg text-white font-semibold"
  ...
  {services.map((service) => (
    <a
      ...
      className="group flex flex-col items-center gap-2 p-4 rounded-2xl border border-white/10
      bg-white/5
    ...
    >
      ...
      <span className="text-white text-xs text-center font-medium">
              ...
              <div className="p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-10">
                  <div>
                    ...
                    <h3 className="text-white font-bold text-xl mt-8 mb-4">
                      What you get
                    </h3>
        ...
        >
          ...
          <Link href="/#contact">
            <button
              className="px-10 py-4 rounded-lg text-white font-bold text-lg"
              style={{ background: "linear-gradient(90deg, #10b981, #059669)" }}
            >
